...
it('should signup a user', async () => {
  ...
  expect(response.body.user).toHaveProperty('email', 'gbolahan@gmail.com')
  expect(response.body.user).toHaveProperty('first_name', 'Gbolahan')
